...
def cropresult(res):
    ...
    weburl="http://www.youtube.com/results?search_query="+corrected_result+"+agriculture"
    return render_template('croprecresult.html', corrected_result=corrected_result,weburl=weburl)
